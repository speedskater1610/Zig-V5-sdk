...
pub fn build(b: *std.Build) void {
    ...
    const vex_module = b.addModule("vex-sdk-jumptable", .{
    ...
    const install_obj = b.addInstallFile(obj.getEmittedBin(), "lib/vex-sdk-jumptable.o");
    ...
    const lib_output = b.pathJoin(&.{ b.install_path, "lib", "libvex-sdk-jumptable.a" });
